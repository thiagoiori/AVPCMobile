...
public class NewServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab_insert_service);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                ...
                case 0:
                    return getString(R.string.new_service_details);
                case 1:
                    return getString(R.string.new_service_map);
                case 2:
                    return getString(R.string.new_service_members);
            }
            return null;
        }
    }
